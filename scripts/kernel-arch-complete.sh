...
if [[ -z $API ]]; then
  ...
  exit 1
    ...
    elif [ "$TREE_NAME" == "kselftest" ]; then
        echo "Sending results for kselftest tree"
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'", "build_report": 1, "format": ["txt"], "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "delay": 60}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-cpufreq", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-filesystems", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-futex", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-lib", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-livepatch", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-lkdtm", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-rtc", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
        curl -X POST -H "Authorization: $EMAIL_AUTH_TOKEN" -H "Content-Type: application/json" -d '{"job": "'$TREE_NAME'", "kernel": "'$GIT_DESCRIBE'", "git_branch": "'$BRANCH'",  "report_type": "test", "plan": "kselftest-seccomp", "send_to": ["kernelci-results@groups.io", "linux-kselftest@vger.kernel.org", "shuah@kernel.org"], "format": ["txt"], "delay": 3600}' ${API}/send
